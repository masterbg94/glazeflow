...
- **The Small Company (Customer / Fabricator / Installer)** — orders those products to create or install windows/doors for *their own* clients.
...
1. **Finished Product Mode** — The small company orders a complete configured window/door unit.  
   Example: *“1 × Tilt-Turn window, 1200×1500 mm, REHAU Total70, double glazed 4/16/4, white, 2 handles.”*

2. **Raw Material Mode** — The small company orders raw materials they will fabricate themselves.  
   Example: *“10 m of REHAU Total70 profile, 4 panes of tempered 6 mm glass, each 800×1200 mm, 12 handles.”*
